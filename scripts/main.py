...
from utils import build_delphi_record, build_pool, data_sanity, delphi_fuzz_scorer, gen_accuracy_score_by_protocol_csv, gen_feature_correlation_scores_csv, gen_feature_accuracy_scores_csv, generate_explanations_air, generate_explanations_neuronpedia, generate_protocol_json, get_baseline, plot_best_protocol_summary, plot_feature_type_area, tabulate_accuracy_score_by_protocol, tabulate_accuracy_score_by_protocol_inverse
...
def aggregate_data(experiment_dir: Path, neuronpedia_types: list[str], embedders: list[str]):
    ...
    tabulate_accuracy_score_by_protocol_inverse(results_dir / "accuracy_score_by_protocol.csv")
    plot_best_protocol_summary(results_dir / "accuracy_score_by_protocol.csv")
    plot_feature_type_area(results_dir)
